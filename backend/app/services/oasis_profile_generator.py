...
# Module-level RNG for investor trait sampling (fat-tail distribution sampling)
    ...
    def generate_profiles_from_entities(
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            ...
            try:
                ...
                if self.storage and profile.source_entity_uuid and profile.investor_traits:
                    try:
