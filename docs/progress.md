...
> **Note:** This file documents the original Zep Cloud → Neo4j migration (Phases 0–7). It is historical. The current architecture is described in the [README](../README.md). All phases below are complete.
